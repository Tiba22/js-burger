...
for (var i = 0; i < lis.length; i++) {
  ...
  li.addEventListener('click', function() {
    ...
    var clickedCheckbox = clickedLiChildrens[1]; //selezione figlio li (input)
...
priceBtn.addEventListener('click', function() {
  ...
  if (burgerName.length < 1) { //nome panino non inserito
    ...
    var burgerCoupon = document.getElementById('burger-coupon').value; //recupero coupon scritto in html
